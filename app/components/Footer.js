          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start">
                ...
                <span>123 Tech Street, Computer Plaza, City - 123456</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span>info@azhkainstitute.com</span>
              </li>
            </ul>

            {/* Social Media */}
            <div className="flex space-x-4 mt-6">
              <a href="#" className="bg-[#1FB6C9] p-2 rounded-full hover:bg-[#0A4C59] transition-colors">
